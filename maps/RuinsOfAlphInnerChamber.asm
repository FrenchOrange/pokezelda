...
RuinsOfAlphInnerChamber_MapEvents:
	...
	def_warp_events
	warp_event 10, 17, RUINS_OF_ALPH_OUTSIDE, 5
	warp_event  3, 19, RUINS_OF_ALPH_HO_OH_CHAMBER, 3
	warp_event  4, 19, RUINS_OF_ALPH_HO_OH_CHAMBER, 4
	warp_event 15,  3, RUINS_OF_ALPH_KABUTO_CHAMBER, 3
	warp_event 16,  3, RUINS_OF_ALPH_KABUTO_CHAMBER, 4
	warp_event  3, 29, RUINS_OF_ALPH_OMANYTE_CHAMBER, 3
	warp_event  4, 29, RUINS_OF_ALPH_OMANYTE_CHAMBER, 4
	warp_event 15, 32, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 3
	warp_event 16, 32, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 4
	...
	bg_event  2, 10, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event  5, 10, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event  8, 10, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 11, 10, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 14, 10, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 17, 10, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event  2, 17, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 17, 17, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	...
	bg_event  2, 32, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event  5, 32, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event  8, 32, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 11, 32, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 14, 32, BGEVENT_READ, RuinsOfAlphInnerChamberStatue
	bg_event 17, 32, BGEVENT_READ, RuinsOfAlphInnerChamberStatue

	def_object_events
	object_event  3,  9, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphInnerChamberFisherScript, EVENT_RUINS_OF_ALPH_INNER_CHAMBER_TOURISTS
	object_event 14, 17, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphInnerChamberTeacherScript, EVENT_RUINS_OF_ALPH_INNER_CHAMBER_TOURISTS
	object_event 11, 25, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphInnerChamberGrampsScript, EVENT_RUINS_OF_ALPH_INNER_CHAMBER_TOURISTS
