...
GoldenrodMagnetTrainStation_MapEvents:
	...
	def_warp_events
	warp_event 11, 17, GOLDENROD_CITY, 5
	warp_event 10, 17, GOLDENROD_CITY, 5
	warp_event  8,  5, SAFFRON_MAGNET_TRAIN_STATION, 4
	warp_event 13,  5, SAFFRON_MAGNET_TRAIN_STATION, 3

	def_coord_events
	coord_event 13,  6, SCENE_DEFAULT, Script_ArriveFromSaffron

	def_bg_events

	def_object_events
	object_event 11,  9, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodMagnetTrainStationOfficerScript, -1
	object_event 13, 14, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodMagnetTrainStationGentlemanScript, EVENT_GOLDENROD_TRAIN_STATION_GENTLEMAN
