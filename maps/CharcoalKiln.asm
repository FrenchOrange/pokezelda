...
CharcoalKiln_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, CharcoalKilnBookshelf
	bg_event  3,  1, BGEVENT_READ, CharcoalKilnBookshelf
	bg_event  9,  1, BGEVENT_READ, CharcoalKilnRadio

	def_object_events
	object_event  4,  3, SPRITE_BLACK_BELT, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CharcoalKilnBoss, EVENT_CHARCOAL_KILN_BOSS
	object_event  7,  3, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CharcoalKilnApprentice, EVENT_CHARCOAL_KILN_APPRENTICE
	object_event  7,  6, SPRITE_BIRD, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CharcoalKilnFarfetchd, EVENT_CHARCOAL_KILN_FARFETCH_D
