...
All the fixes from vanilla pokecrystal's bugs and gliches document have been implemented here, aside from the ones related to the multi-player battle engine. This is because fixes to this section will break compatibility with standard Pokémon Gold/Silver/Crystal for link battles.
...
**Fix:** Edit [gfx/tilesets/roofs.pal](https://github.com/pret/pokecrystal/blob/master/gfx/tilesets/roofs.pal) to change to roof colors:
