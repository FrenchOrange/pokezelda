...
GoldenrodPPSpeechHouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, GoldenrodPPSpeechHouseBookshelf1
	bg_event  3,  1, BGEVENT_READ, GoldenrodPPSpeechHouseBookshelf2
	bg_event  9,  1, BGEVENT_READ, GoldenrodPPSpeechHouseRadio

	def_object_events
	object_event  4,  4, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodPPSpeechHouseFisherScript, -1
	object_event  7,  3, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodPPSpeechHouseLassScript, -1
