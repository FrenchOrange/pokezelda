...
.returnfrombattle
	...
	showemote EMOTE_QUESTION, BURNEDTOWER1F_SILVER, 15
...
BurnedTower1F_MapEvents:
	...
	def_warp_events
	warp_event  9, 16, ECRUTEAK_CITY, 13
	warp_event 10, 16, ECRUTEAK_CITY, 13
	...
	warp_event  5, 15, BURNED_TOWER_B1F, 6 ; inaccessible, left over from G/S
	...
	object_event 14, 14, SPRITE_MORTY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BurnedTower1FMortyScript, EVENT_BURNED_TOWER_MORTY
