...
ViridianCityDreamEaterFisher:
	showemote EMOTE_SLEEP, VIRIDIANCITY_FISHER, 25
	faceplayer
	opentext
...
ViridianCityTipsSign1:
	jumptext ViridianCityTipsSign1Text

ViridianCityTipsSign2:
	jumptext ViridianCityTipsSign2Text
...
ViridianCityHiddenFullHeal:
	hiddenitem FULL_HEAL, EVENT_VIRIDIAN_CITY_HIDDEN_FULL_HEAL
...
ViridianCity_MapEvents:
	...
	bg_event  1, 17, BGEVENT_READ, ViridianCityWelcomeSign
	bg_event 21, 17, BGEVENT_READ, TrainerHouseSign
	bg_event 24, 25, BGEVENT_READ, ViridianCityPokecenterSign
	bg_event 30, 19, BGEVENT_READ, ViridianCityMartSign
	bg_event 21, 29, BGEVENT_READ, ViridianCityTipsSign1
	bg_event 19,  1, BGEVENT_READ, ViridianCityTipsSign2
	bg_event 14,  4, BGEVENT_ITEM, ViridianCityHiddenFullHeal
