...
; entries correspond to constants/landmark_constants.asm
	...
	landmark  84,  58, SproutTowerName
	...
	landmark  36,  44, Route39Name
	landmark  36,  60, OlivineCityName
	landmark  38,  60, LighthouseName
	landmark  28,  60, Route40Name
	landmark  28,  56, BattleTowerName
	landmark  28,  76, Route41Name
...
CeladonCondoName:    db "CELADON¯CONDO@"
