...
MapGroup_Dungeons:
	...
	map RuinsOfAlphHoOhWordRoom, TILESET_RUINS_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphKabutoWordRoom, TILESET_RUINS_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphOmanyteWordRoom, TILESET_RUINS_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphAerodactylWordRoom, TILESET_RUINS_WORD_ROOM, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodUndergroundSwitchRoomEntrances, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_UNION_CAVE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom3, TILESET_CAVE, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map SilverCaveItemRooms, TILESET_CAVE, CAVE, LANDMARK_MT_SILVER, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map UndergroundPathWestEast, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_MT_MOON, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map SafariZoneFuchsiaGate, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZone, TILESET_PARK, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneRestHouse, TILESET_HOUSE, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadChamber, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map VictoryRoad1F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map VictoryRoad2F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map VictoryRoad3F, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Ecruteak:
	...
	map WiseTriosRoom, TILESET_TOWER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map EcruteakEvoGuyHouse, TILESET_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Cinnabar:
	...
	map FuchsiaCityFisherHouse, TILESET_HOUSE, GATE, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SummerBeachHouse, TILESET_HOUSE, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map Route4Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_4, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route9, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_9, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route10, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Vermilion:
	...
	map Route11Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route6UndergroundPathEntrance, TILESET_UNDERGROUND, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMuseum1F, TILESET_FACILITY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum2F, TILESET_FACILITY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum3F, TILESET_FACILITY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseumB1F, TILESET_FACILITY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route8UndergroundPathEntrance, TILESET_UNDERGROUND, GATE, LANDMARK_ROUTE_8, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map SilverCaveOutside, TILESET_KANTO, TOWN, LANDMARK_MT_SILVER, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SilverCavePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_MT_SILVER, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonMansion1F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CONDO, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion2F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CONDO, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion3F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CONDO, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoof, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CONDO, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route16Gate2, TILESET_GATE, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonHotel, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonChiefHouse, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SilphCo1F, TILESET_FACILITY, INDOOR, LANDMARK_SILPH_CO, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route5UndergroundPathEntrance, TILESET_UNDERGROUND, GATE, LANDMARK_ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map Route7UndergroundPathEntrance, TILESET_UNDERGROUND, GATE, LANDMARK_ROUTE_7, MUSIC_ROUTE_3, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map SilphCoElevator, TILESET_FACILITY, INDOOR, LANDMARK_SILPH_CO, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCoRD, TILESET_FACILITY, INDOOR, LANDMARK_SILPH_CO, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
