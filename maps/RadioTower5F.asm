...
RadioTower5FRocketBossScene:
	...
	moveobject RADIOTOWER5F_DIRECTOR, 16, 0
...
RadioTower5F_MapEvents:
	...
	def_warp_events
	warp_event  2,  0, RADIO_TOWER_4F, 1
	warp_event 16,  0, RADIO_TOWER_4F, 3

	def_coord_events
	coord_event  2,  3, SCENE_DEFAULT, FakeDirectorScript
	coord_event 20,  5, SCENE_RADIOTOWER5F_ROCKET_BOSS, RadioTower5FRocketBossScene

	def_bg_events
	bg_event  5,  0, BGEVENT_READ, RadioTower5FDirectorsOfficeSign
	bg_event 15,  0, BGEVENT_READ, RadioTower5FStudio1Sign
	bg_event 19,  0, BGEVENT_READ, RadioTower5FStudio1Sign
	bg_event 20,  1, BGEVENT_READ, RadioTower5FBookshelf
	bg_event 21,  1, BGEVENT_READ, RadioTower5FBookshelf

	def_object_events
	object_event  5,  6, SPRITE_GENTLEMAN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Director, -1
	object_event 17,  5, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 21,  2, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 1, TrainerExecutivef1, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 17,  5, SPRITE_ROCKER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Ben, EVENT_RADIO_TOWER_CIVILIANS_AFTER
	object_event 12,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RadioTower5FUltraBall, EVENT_RADIO_TOWER_5F_ULTRA_BALL
