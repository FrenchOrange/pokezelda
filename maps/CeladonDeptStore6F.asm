...
CeladonDeptStore6F_MapEvents:
	...
	def_warp_events
	warp_event 17,  0, CELADON_DEPT_STORE_5F, 2
	warp_event  4,  0, CELADON_DEPT_STORE_ELEVATOR, 1

	def_coord_events

	def_bg_events
	bg_event 16,  0, BGEVENT_READ, CeladonDeptStore6FDirectory
	...
	bg_event 12,  1, BGEVENT_UP, CeladonDeptStore6FVendingMachine
	bg_event 13,  1, BGEVENT_UP, CeladonDeptStore6FVendingMachine

	def_object_events
	object_event 11,  2, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore6FSuperNerdScript, -1
	object_event 14,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 2, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore6FYoungsterScript, -1
