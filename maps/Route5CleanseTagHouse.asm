...
Route5CleanseTagHouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, HouseForSaleBookshelf
	bg_event  3,  1, BGEVENT_READ, HouseForSaleBookshelf

	def_object_events
	object_event  4,  5, SPRITE_GRANNY, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route5CleanseTagHouseGrannyScript, -1
	object_event  7,  3, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route5CleanseTagHouseTeacherScript, -1
