...
WillsRoom_MapEvents:
	...
	def_warp_events
	warp_event  7, 17, INDIGO_PLATEAU_POKECENTER_1F, 4
	warp_event  6,  2, KOGAS_ROOM, 1
	warp_event  7,  2, KOGAS_ROOM, 2
	...
	def_object_events
	object_event  7,  7, SPRITE_WILL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, WillScript_Battle, -1
