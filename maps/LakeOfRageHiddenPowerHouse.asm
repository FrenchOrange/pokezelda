...
LakeOfRageHiddenPowerHouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, HiddenPowerHouseBookshelf
	bg_event  3,  1, BGEVENT_READ, HiddenPowerHouseBookshelf

	def_object_events
	object_event  4,  3, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, HiddenPowerGuy, -1
