...
Route12SuperRodHouseFishingGuruScript:
	...
	showemote EMOTE_FISH, ROUTE12SUPERRODHOUSE_FISHING_GURU, 25
	promptbutton
...
Route12SuperRodHouse_MapEvents:
	...
	def_object_events
	object_event  7,  3, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route12SuperRodHouseFishingGuruScript, -1
