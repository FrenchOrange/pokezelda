...
MortyGroup:
	...
	db 23, MISDREAVUS, PSYWAVE, SPITE, CONFUSE_RAY, MEAN_LOOK
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 30, SWINUB,     TACKLE, POWDER_SNOW, ENDURE, ROAR
...
ExecutiveFGroup:
	...
	db 33, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 33, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 35, MURKROW,    PECK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
