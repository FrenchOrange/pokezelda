...
JanineGroup:
	...
	db 44, MUK,        ACID_ARMOR, TOXIC, MINIMIZE, SLUDGE
...
ExecutiveMGroup:
	; EXECUTIVEM (1) ; "Archer" (Radio Tower 5F)
	...
	db 38, SNEASEL,    THIEF, FRUSTRATION, SLASH, AGILITY
	db 42, HOUNDOOM,   EMBER, SMOG, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2) ; "Proton" (Radio Tower 4F)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 33, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 36, HOUNDOOM,   EMBER, SMOG, BITE, FAINT_ATTACK
	db 38, FORRETRESS, ENDURE, SELFDESTRUCT, TAKE_DOWN, RAPID_SPIN
	db -1 ; end

	; EXECUTIVEM (3) ; "Petrel" (Radio Tower Director)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	...
	db 38, RATICATE,   TACKLE, SCARY_FACE, PURSUIT, SUPER_FANG
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1) ; "Ariana" (Radio Tower 5F)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	...
	db 35, MISDREAVUS, CONFUSE_RAY, MEAN_LOOK, PSYBEAM, PAIN_SPLIT
	db 38, SNEASEL,    THIEF, FRUSTRATION, SLASH, AGILITY
	db -1 ; end
