...
Route31MailRecipientScript:
	showemote EMOTE_SLEEP, ROUTE31_FISHER, 25
	faceplayer
	opentext
...
Route31_MapEvents:
	...
	object_event 21, 13, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, TrainerBugCatcherWade1, -1
