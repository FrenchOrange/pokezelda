...
TilesetIcePathAnim:
	dw vTiles2 tile $23, AnimateWaterTile
	dw NULL,  FlickeringCaveEntrancePalette
	dw wTileAnimBuffer, ScrollTileRightLeft
	dw NULL,  FlickeringCaveEntrancePalette
	dw vTiles2 tile $23, AnimateWaterTile
...
TilesetGateAnim:
	dw vTiles2 tile $4C, AnimateTorchTile
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
...
TilesetChampionsRoomAnim:
	dw vTiles2 tile $5A, AnimateTorchTile
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
...
TilesetBattleTowerInsideAnim:
	dw vTiles2 tile $26, AnimateTorchTile
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
...
.TorchTile3: INCBIN "gfx/tilesets/torch/3.2bpp"
.TorchTile4: INCBIN "gfx/tilesets/torch/4.2bpp"
