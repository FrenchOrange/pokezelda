...
.Frameset_GSIntroHoOhLugia:
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_1, 8
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_2, 8
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_3, 8
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_4, 8
	dorestart
