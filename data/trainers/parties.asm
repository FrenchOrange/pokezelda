...
FalknerGroup:
	...
	db  9, HOOTHOOT,   TACKLE, PECK, NO_MOVE, NO_MOVE
...
WhitneyGroup:
	...
	db 19, AIPOM,      TAIL_WHIP, SAND_ATTACK, BATON_PASS, FURY_SWIPES
...
BugsyGroup:
	...
	db 15, LEDYBA,     TACKLE, SUPERSONIC, RETURN, NO_MOVE
...
MortyGroup:
	...
	db 24, MISDREAVUS, PSYWAVE, SPITE, CONFUSE_RAY, MEAN_LOOK
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 31, SWINUB,     TACKLE, POWDER_SNOW, ENDURE, ROAR
...
JasmineGroup:
	...
	db 32, FORRETRESS, TACKLE, TAKE_DOWN, RAPID_SPIN, BIDE
...
ChuckGroup:
	...
	db 28, MACHOKE,     DYNAMICPUNCH, STRENGTH, MUD_SLAP, PROTECT
	db 28, HITMONTOP,   QUICK_ATTACK, PURSUIT, RAPID_SPIN, TACKLE
...
ClairGroup:
	...
	db 39, DRAGONITE,  THUNDER_WAVE, ICE_BEAM, TWISTER, DRAGONBREATH
	db 41, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end

Rival1Group:
	; RIVAL1 (1) ; Cherrygrove City
	db "?@", TRAINERTYPE_NORMAL
	db  5, CHIKORITA
	db -1 ; end

	; RIVAL1 (2) ; Cherrygrove City
	db "?@", TRAINERTYPE_NORMAL
	db  5, CYNDAQUIL
	db -1 ; end

	; RIVAL1 (3) ; Cherrygrove City
	db "?@", TRAINERTYPE_NORMAL
	db  5, TOTODILE
	db -1 ; end
...
WillGroup:
	...
	db 42, GIRAFARIG,  PSYBEAM, STOMP, EARTHQUAKE, SHADOW_BALL
	db -1 ; end
...
BrockGroup:
	...
	db 52, GOLEM,      ROCK_THROW, MAGNITUDE, DEFENSE_CURL, ROLLOUT
	db -1 ; end
...
MistyGroup:
	...
	db 48, LANTURN,    SURF, WATER_GUN, SPARK, TAKE_DOWN
	db 48, SEAKING,    SURF, FURY_ATTACK, WATERFALL, HORN_DRILL
	db -1 ; end
...
LtSurgeGroup:
	...
	db 47, JOLTEON,    ROAR, HIDDEN_POWER, THUNDERPUNCH, THUNDER_WAVE
	db -1 ; end
...
ErikaGroup:
	...
	db 56, VILEPLUME,  SUNNY_DAY, SLEEP_POWDER, PETAL_DANCE, SOLARBEAM
	db 51, EXEGGCUTE,  HYPNOSIS, LEECH_SEED, TOXIC, PSYCHIC_M
	db -1 ; end
...
SchoolboyGroup:
	...
	db 32, FURRET,     QUICK_ATTACK, FURY_SWIPES, SLAM, TACKLE
...
LassGroup:
	...
	db 12, MAREEP,    TACKLE, GROWL, NO_MOVE, NO_MOVE
...
JanineGroup:
	...
	db 47, ARIADOS,    SWAGGER, TOXIC, DIG, SPIDER_WEB
...
CooltrainerMGroup:
	...
	db 29, URSARING,   FURY_SWIPES, LEER, FAINT_ATTACK, ROAR
	db 29, DONPHAN,    FLAIL, FURY_ATTACK, TAKE_DOWN, TACKLE
	db -1 ; end
	...
	db 35, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 38, LANTURN,    NO_ITEM,      WATER_GUN, SPARK, CONFUSE_RAY, TAKE_DOWN
	db -1 ; end
...
SabrinaGroup:
	...
	db 53, HYPNO,      HYPNOSIS, DREAM_EATER, CONFUSION, MEGA_PUNCH
	db 54, SLOWBRO,    PSYCHIC_M, SURF, FIRE_BLAST, EARTHQUAKE
	db 54, KADABRA,    DISABLE, PSYBEAM, PSYCHIC_M, REFLECT
...
BugCatcherGroup:
	...
	db 24, LEDIAN, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end
...
SwimmerFGroup:
	...
	db 24, MANTINE,    TACKLE, BUBBLE, SUPERSONIC, BUBBLEBEAM 
	db -1 ; end
...
HikerGroup:
	...
	; HIKER (23)
	db "ANTOINE@", TRAINERTYPE_NORMAL
	db 36, RHYDON
	db -1 ; end

	; HIKER (24)
	db "FREDERICK@", TRAINERTYPE_NORMAL
	db 19, MACHOP
	db 24, MACHOKE
	db 31, MACHAMP
	db -1 ; end
...
BlaineGroup:
	...
	db 54, FLAREON,    TAKE_DOWN, FIRE_BLAST, SUNNY_DAY, SHADOW_BALL
	db 56, NINETALES,  QUICK_ATTACK, FIRE_BLAST, SUNNY_DAY, DIG
	db 56, ARCANINE,   EXTREMESPEED, FIRE_BLAST, SUNNY_DAY, ROAR
...
ExecutiveMGroup:
	; EXECUTIVEM (1) ; "Archer" (Radio Tower)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 45, HOUNDOUR,   EMBER, ROAR, BITE, FAINT_ATTACK
	db 45, KOFFING,    TACKLE, SLUDGE, SMOKESCREEN, HAZE
	db 48, ARBOK,      WRAP, POISON_STING, BITE, GLARE
	db 48, SNEASEL,    THIEF, FRUSTRATION, SLASH, AGILITY
	db 52, HOUNDOOM,   EMBER, SMOG, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2) ; "Proton" (Radio Tower)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 43, WEEZING,    SLUDGE, SELFDESTRUCT, SMOKESCREEN, SMOG
	db 46, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 48, HOUNDOOM,   EMBER, SMOG, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (3) ; "Petrel" (Radio Tower)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	...
	db 40, RATICATE,   TACKLE, SCARY_FACE, PURSUIT, SUPER_FANG
	db -1 ; end

	; EXECUTIVEM (4) ; "Petrel" (Rocket Hideout)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 34, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, RATICATE,   TACKLE, SCARY_FACE, PURSUIT, SUPER_FANG
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1) ; "Ariana" (Radio Tower)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	...
	db 45, MISDREAVUS, CONFUSE_RAY, MEAN_LOOK, PSYBEAM, PAIN_SPLIT
	db 48, SNEASEL,    THIEF, FRUSTRATION, SLASH, AGILITY
	db -1 ; end

	; EXECUTIVEF (2) ; "Ariana" (Rocket Hideout)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, ARBOK,      WRAP, LEER, POISON_STING, BITE
	db 31, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 31, GLOOM,      ABSORB, SWEET_SCENT, SLEEP_POWDER, ACID
	db 34, MURKROW,    PECK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
...
BoarderGroup:
	...
	db 41, CLOYSTER,   SPIKE_CANNON, AURORA_BEAM, PROTECT, WITHDRAW
	db -1 ; end
...
RedGroup:
	...
	db 80, LAPRAS,     BODY_SLAM, WATER_GUN, BLIZZARD, PSYCHIC_M
