...
CeruleanCityTipsSign:
	jumptext CeruleanCityTipsSignText
...
CeruleanCityCaveNPCScript:
	faceplayer
	opentext
	readvar VAR_BADGES
	ifequal NUM_BADGES, .CaveOpenNPCScript
	writetext CeruleanCityCaveNPCText
	waitbutton
	closetext
	end

.CaveOpenNPCScript:
	writetext CeruleanCityCaveNPC2Text
	waitbutton
	closetext
	end
...
CeruleanCityCaveNPCText:
	text "On TV they said"
	...
	para "It looks like this"
	line "rubble won't budge"
	cont "for some time…"
	done

CeruleanCityCaveNPC2Text:
	text "The cave that lies"
	line "ahead is full of"
...
CeruleanCity_MapEvents:
	...
	bg_event 25, 11, BGEVENT_READ, CeruleanPoliceSign
	bg_event 17, 29, BGEVENT_READ, CeruleanCityTipsSign
	bg_event 20, 17, BGEVENT_READ, CeruleanCityPokecenterSign
	bg_event 26, 25, BGEVENT_READ, CeruleanCityMartSign
	bg_event 13,  3, BGEVENT_ITEM, CeruleanCityHiddenBerserkGene
	...
	object_event 23, 13, SPRITE_SUPER_NERD, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeruleanCitySuperNerdScript, -1
	object_event 20, 26, SPRITE_SLOWBRO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, CeruleanCitySlowbro, -1
	...
	object_event 12,  8, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeruleanCityYoungsterScript, -1
	object_event  3, 12, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeruleanCityCaveNPCScript, -1
