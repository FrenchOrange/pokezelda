...
FastShipCabins_SW_SSW_NW_MapEvents:
	...
	def_warp_events
	warp_event  4,  2, FAST_SHIP_1F, 5
	warp_event 18,  9, FAST_SHIP_1F, 6
	warp_event 19,  9, FAST_SHIP_1F, 6
	warp_event  4, 23, FAST_SHIP_1F, 7
	warp_event  5, 23, FAST_SHIP_1F, 7

	def_coord_events

	def_bg_events
	bg_event  9,  3, BGEVENT_READ, FastShipBed
	bg_event  9,  4, BGEVENT_READ, FastShipBed
	bg_event  9,  9, BGEVENT_READ, FastShipCabinsNorthwestCabinTrashcan

	def_object_events
	object_event 17,  5, SPRITE_FISHER, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerFirebreatherLyle, EVENT_FAST_SHIP_PASSENGERS_FIRST_TRIP
	object_event 22,  5, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBugCatcherKen, EVENT_FAST_SHIP_PASSENGERS_WESTBOUND
	object_event  3, 18, SPRITE_BEAUTY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerBeautyCassie, EVENT_FAST_SHIP_PASSENGERS_EASTBOUND
	object_event  5, 20, SPRITE_ROCKER, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerGuitaristClyde, EVENT_FAST_SHIP_PASSENGERS_WESTBOUND
