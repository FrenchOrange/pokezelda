...
VermilionFishingSpeechHouse_MapEvents:
	...
	def_bg_events
	bg_event  5,  0, BGEVENT_READ, FishingDudesHousePhoto

	def_object_events
	object_event  4,  4, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, FishingDude, -1
