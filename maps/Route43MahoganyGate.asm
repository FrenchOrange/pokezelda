...
Route43MahoganyGate_MapEvents:
	...
	warp_event  7,  0, ROUTE_43, 2
	warp_event  6,  7, MAHOGANY_TOWN, 5
	...
	def_object_events
	object_event  2,  4, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route43MahoganyGateOfficer, -1
