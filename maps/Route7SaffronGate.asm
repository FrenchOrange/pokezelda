...
Route7SaffronGate_MapEvents:
	...
	def_warp_events
	warp_event  2,  4, ROUTE_7, 1
	warp_event  2,  5, ROUTE_7, 2
	warp_event 11,  4, SAFFRON_CITY, 9
	warp_event 11,  5, SAFFRON_CITY, 10
	...
	def_object_events
	object_event  7,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route7SaffronGuardScript, -1
