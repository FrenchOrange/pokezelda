...
Route27SandstormHouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, SandstormHouseBookshelf
	bg_event  3,  1, BGEVENT_READ, SandstormHouseBookshelf

	def_object_events
	object_event  4,  4, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SandstormHouseWoman, -1
