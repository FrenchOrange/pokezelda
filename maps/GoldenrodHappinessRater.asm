...
GoldenrodHappinessRater_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, HappinessRatersHouseBookshelf
	bg_event  3,  1, BGEVENT_READ, HappinessRatersHouseBookshelf
	bg_event  9,  1, BGEVENT_READ, HappinessRatersHouseRadio
	...
	object_event  7,  3, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodHappinessRaterPokefanMScript, -1
	object_event  7,  6, SPRITE_TWIN, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodHappinessRaterTwinScript, -1
