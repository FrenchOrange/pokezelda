...
MapScenes::
	...
	scene_var PEWTER_MUSEUM_1F,                            wPewterMuseum1FSceneID ; new
	...
	scene_var SILPH_CO_ELEVATOR,                           wSilphCoElevatorSceneID ; new
	scene_var SILPH_CO_RD,                                 wSilphCoRDSceneID ; new
	db -1 ; end
