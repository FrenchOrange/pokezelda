...
.Boulders:
	...
	iffalse .skip1
	changeblock 10, 2, $3b ; fallen boulder 2
.skip1
	checkevent EVENT_BOULDER_IN_BLACKTHORN_GYM_2
	iffalse .skip2
	changeblock 4, 4, $3a ; fallen boulder 1
.skip2
	checkevent EVENT_BOULDER_IN_BLACKTHORN_GYM_3
	iffalse .skip3
	changeblock 10, 6, $3b ; fallen boulder 2
.skip3
	endcallback
...
BlackthornGym1F_MapEvents:
	...
	def_warp_events
	warp_event  6, 17, BLACKTHORN_CITY, 1
	warp_event  7, 17, BLACKTHORN_CITY, 1
	warp_event  3,  7, BLACKTHORN_GYM_2F, 1
	warp_event  9,  9, BLACKTHORN_GYM_2F, 2
	warp_event  4,  6, BLACKTHORN_GYM_2F, 3
	warp_event  9,  7, BLACKTHORN_GYM_2F, 4
	warp_event  9,  6, BLACKTHORN_GYM_2F, 5

	def_coord_events

	def_bg_events
	bg_event  5, 15, BGEVENT_READ, BlackthornGymStatue
	bg_event  8, 15, BGEVENT_READ, BlackthornGymStatue

	def_object_events
	object_event  7,  3, SPRITE_CLAIR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, BlackthornGymClairScript, -1
	object_event  8,  6, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerCooltrainermMike, -1
	...
	object_event 11,  2, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerCooltrainerfLola, -1
	object_event  9, 15, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BlackthornGymGuideScript, -1
