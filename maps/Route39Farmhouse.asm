...
Route39Farmhouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, FarmhouseBookshelf
	bg_event  3,  1, BGEVENT_READ, FarmhouseBookshelf

	def_object_events
	object_event  5,  2, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, PokefanM_DairyFarmer, -1
	object_event  7,  4, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, PokefanF_SnoreFarmer, -1
