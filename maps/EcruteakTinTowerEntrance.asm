...
EcruteakTinTowerEntranceSageBlocksLeft:
	...
	moveobject ECRUTEAKTINTOWERENTRANCE_SAGE1, 6, 6
...
EcruteakTinTowerEntranceSageBlocksRight:
	...
	moveobject ECRUTEAKTINTOWERENTRANCE_SAGE2, 7, 6
...
EcruteakTinTowerEntrance_MapEvents:
	...
	def_warp_events
	warp_event  6, 18, ECRUTEAK_CITY, 3
	warp_event  7, 18, ECRUTEAK_CITY, 3
	warp_event  7,  3, ECRUTEAK_TIN_TOWER_ENTRANCE, 4
	warp_event 21, 15, ECRUTEAK_TIN_TOWER_ENTRANCE, 3
	warp_event 21,  3, WISE_TRIOS_ROOM, 3

	def_coord_events
	coord_event  6,  7, SCENE_DEFAULT, EcruteakTinTowerEntranceSageBlocksLeft
	coord_event  7,  7, SCENE_DEFAULT, EcruteakTinTowerEntranceSageBlocksRight

	def_bg_events

	def_object_events
	object_event  6,  6, SPRITE_SAGE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakTinTowerEntranceSageScript, EVENT_RANG_CLEAR_BELL_1
	object_event  7,  6, SPRITE_SAGE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakTinTowerEntranceSageScript, EVENT_RANG_CLEAR_BELL_2
	object_event  8,  9, SPRITE_SAGE, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakTinTowerEntranceWanderingSageScript, EVENT_ECRUTEAK_TIN_TOWER_ENTRANCE_WANDERING_SAGE
	object_event  5, 11, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakTinTowerEntranceGrampsScript, EVENT_ECRUTEAK_TIN_TOWER_ENTRANCE_WANDERING_SAGE
