...
MrPokemonsHouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, MrPokemonsHouse_ForeignMagazines
	bg_event  3,  1, BGEVENT_READ, MrPokemonsHouse_ForeignMagazines
	...
	object_event  8,  5, SPRITE_OAK, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MR_POKEMONS_HOUSE_OAK
