...
DanceTheatre_MapEvents:
	...
	def_warp_events
	warp_event  7, 13, ECRUTEAK_CITY, 8
	warp_event  8, 13, ECRUTEAK_CITY, 8

	def_coord_events

	def_bg_events
	bg_event  7,  6, BGEVENT_UP, DanceTheatreFancyPanel
	bg_event  8,  6, BGEVENT_UP, DanceTheatreFancyPanel
	...
	object_event 11,  1, SPRITE_KIMONO_GIRL, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, TrainerKimonoGirlKuni, -1
