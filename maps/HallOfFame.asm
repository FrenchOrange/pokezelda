...
.EnterHallOfFameScript:
	...
	clearevent EVENT_ONIX_DOLL_RECEPTIONIST
...
HallOfFame_MapEvents:
	...
	def_warp_events
	warp_event  6, 13, LANCES_ROOM, 3
	warp_event  7, 13, LANCES_ROOM, 4
	...
	def_object_events
	object_event  6, 12, SPRITE_LANCE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
