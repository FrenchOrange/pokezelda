...
ENDM
	...
	connection west, Route16, ROUTE_16, 3
	...
	connection north, SaffronCity, SAFFRON_CITY, -6
	...
	connection south, Route6, ROUTE_6, 6
	...
	connection south, SaffronCity, SAFFRON_CITY, -6
