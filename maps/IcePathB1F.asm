...
TrainerBoarderJulien:
	trainer BOARDER, JULIEN, EVENT_BEAT_BOARDER_JULIEN, BoarderJulienSeenText, BoarderJulienBeatenText, 0, .Script

.Script:
	endifjustbattled
	opentext
	writetext BoarderJulienAfterBattleText
	waitbutton
	closetext
	end
...
BoarderJulienSeenText:
	text "I've learned a new"
	line "trick. Look!"
	done
...
BoarderJulienAfterBattleText:
	text "It's lonely down"
	line "here, but at least"

	para "I can focus on my"
	line "moves."
	done
...
IcePathB1F_MapEvents:
	...
	def_object_events
	object_event 15, 25, SPRITE_ROCKER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerBoarderJulien, -1
