...
Route32RuinsOfAlphGate_MapEvents:
	...
	def_warp_events
	warp_event  2,  4, RUINS_OF_ALPH_OUTSIDE, 10
	warp_event  2,  5, RUINS_OF_ALPH_OUTSIDE, 11
	...
	def_object_events
	object_event  7,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route32RuinsOfAlphGateOfficerScript, -1
	...
	object_event  3,  6, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route32RuinsOfAlphGateYoungsterScript, -1
