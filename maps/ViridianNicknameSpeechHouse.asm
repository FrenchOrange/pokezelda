...
ViridianNicknameSpeechHouse_MapEvents:
	...
	object_event  7,  2, SPRITE_SPEAROW, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Speary, -1
	object_event  8,  3, SPRITE_RATTATA, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, Rattey, -1
