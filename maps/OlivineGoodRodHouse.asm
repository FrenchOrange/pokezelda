...
GoodRodGuru:
	...
	showemote EMOTE_FISH, OLIVINEGOODRODHOUSE_FISHING_GURU, 25
	promptbutton
...
OlivineGoodRodHouse_MapEvents:
	...
	def_object_events
	object_event  4,  3, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoodRodGuru, -1
