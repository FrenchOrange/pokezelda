...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const VIRIDIAN_FOREST,                             17, 29 ; NEW
	endgroup
	...
	map_const SAFFRON_CITY,                                22, 18 ;  2
