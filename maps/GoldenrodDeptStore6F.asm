...
GOLDENRODDEPTSTORE6F_LEMONADE_PRICE    EQU 350
	...
	const GOLDENRODDEPTSTORE6F_SUPER_NERD2
...
GoldenrodDeptStore6FSuperNerd1Script:
	jumptextfaceplayer GoldenrodDeptStore6FSuperNerd1Text

GoldenrodDeptStore6FSuperNerd2Script:
	jumptextfaceplayer GoldenrodDeptStore6FSuperNerd2Text
...
GoldenrodDeptStore6FSuperNerd1Text:
...
GoldenrodDeptStore6FSuperNerd2Text:
	text "I, I, I'm really"
	line "impatient!"
...
GoldenrodDeptStore6F_MapEvents:
	...
	def_warp_events
	warp_event 17,  0, GOLDENROD_DEPT_STORE_5F, 2
	warp_event  4,  0, GOLDENROD_DEPT_STORE_ELEVATOR, 1
	warp_event 14,  0, GOLDENROD_DEPT_STORE_ROOF, 1

	def_coord_events

	def_bg_events
	bg_event 16,  0, BGEVENT_READ, GoldenrodDeptStore6FDirectory
	bg_event  5,  0, BGEVENT_READ, GoldenrodDeptStore6FElevatorButton
	bg_event 10,  1, BGEVENT_UP, GoldenrodVendingMachine
	bg_event 11,  1, BGEVENT_UP, GoldenrodVendingMachine
	bg_event 12,  1, BGEVENT_UP, GoldenrodVendingMachine
	bg_event 13,  1, BGEVENT_UP, GoldenrodVendingMachine

	def_object_events
	object_event 12,  2, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStore6FLassScript, -1
	object_event 10,  2, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStore6FSuperNerd1Script, -1
	object_event 16,  5, SPRITE_SUPER_NERD, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStore6FSuperNerd2Script, -1
