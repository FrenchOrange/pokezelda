...
GoldenrodUndergroundSwitchRoomEntrances_MapEvents:
	...
	def_warp_events
	warp_event 25,  3, GOLDENROD_UNDERGROUND, 6
	warp_event 24, 10, GOLDENROD_UNDERGROUND_WAREHOUSE, 1
	warp_event 25, 10, GOLDENROD_UNDERGROUND_WAREHOUSE, 2
	warp_event  9, 25, GOLDENROD_UNDERGROUND, 2
	warp_event  8, 29, GOLDENROD_CITY, 14
	warp_event  9, 29, GOLDENROD_CITY, 14
	warp_event 25, 25, GOLDENROD_UNDERGROUND, 1
	warp_event 24, 29, GOLDENROD_CITY, 13
	warp_event 25, 29, GOLDENROD_CITY, 13

	def_coord_events
	coord_event 21,  4, SCENE_DEFAULT, UndergroundSilverScene1
	coord_event 21,  5, SCENE_DEFAULT, UndergroundSilverScene2

	def_bg_events
	bg_event 18,  1, BGEVENT_READ, Switch1Script
	bg_event 12,  1, BGEVENT_READ, Switch2Script
	bg_event  4,  1, BGEVENT_READ, Switch3Script
	bg_event 22, 11, BGEVENT_READ, EmergencySwitchScript
	bg_event 10,  9, BGEVENT_ITEM, GoldenrodUndergroundSwitchRoomEntrancesHiddenMaxPotion
	bg_event  3,  8, BGEVENT_ITEM, GoldenrodUndergroundSwitchRoomEntrancesHiddenRevive

	def_object_events
	object_event 11, 12, SPRITE_PHARMACIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBurglarDuncan, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event  6,  8, SPRITE_PHARMACIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBurglarEddie, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 19,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM13, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event 13,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM11, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event  5,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM25, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
