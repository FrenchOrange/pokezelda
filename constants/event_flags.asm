...
; Johto story events
	...
	const EVENT_LAKE_OF_RAGE_REWARD_ON_STANDBY
	const EVENT_TRASHCAN_FASTSHIP
	...
	const EVENT_GOT_TALON
	const EVENT_GAVE_TALON
...
; Kanto story events
	...
	const EVENT_ADDED_MOUSTACHE_TO_GRAFFITI
	...
	const EVENT_WENT_TO_SILPH_CO_RD_ONCE
; Kanto hidden items
	...
	const EVENT_UNDERGROUND_PATH_WEST_EAST_HIDDEN_NUGGET
	const EVENT_UNDERGROUND_PATH_WEST_EAST_HIDDEN_X_ATTACK
	...
	const EVENT_VIRIDIAN_CITY_HIDDEN_FULL_HEAL
	...
	const EVENT_SEAFOAM_ISLANDS_B3F_HIDDEN_MAX_ELIXIR
	const EVENT_SEAFOAM_ISLANDS_B4F_HIDDEN_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_RARE_CANDY
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_BRIGHTPOWDER
...
; New to Crystal Awakening
	...
	const EVENT_SWITCH_IN_VICTORY_ROAD_1F
...
; Oaks Lab Flags
	...
	const EVENT_TALKED_TO_BLUE_IN_OAKS_LAB
	const EVENT_GOT_SPARE_STARTER
; Legendary Bird flags
	const EVENT_SEAFOAM_ISLANDS_B4F_ARTICUNO_AVAILABLE
	const EVENT_POWER_PLANT_ZAPDOS_AVAILABLE
	const EVENT_VICTORY_ROAD_CHAMBER_MOLTRES_AVAILABLE
; Phone events
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_ONIX_DOLL_RECEPTIONIST
...
; Boarder
	...
	const EVENT_BEAT_BOARDER_MARTY
	const EVENT_BEAT_BOARDER_JULIEN
	const EVENT_BEAT_BOARDER_JACQUES
	const EVENT_BEAT_BOARDER_BRENDON
; Sage
...
; Burglar
	...
	const EVENT_BEAT_BURGLAR_EVAN
	const EVENT_BEAT_BURGLAR_WREN
; Biker
	const EVENT_BEAT_BIKER_DARRELL
...
; Picnicker
	...
	const EVENT_BEAT_PICNICKER_PLUM
	const EVENT_BEAT_PICNICKER_DIANE
	const EVENT_BEAT_PICNICKER_CATHY
; Guitarist
	const EVENT_BEAT_GUITARIST_CLYDE
	const EVENT_BEAT_GUITARIST_VINCENT
	const EVENT_BEAT_GUITARIST_ELI
	const EVENT_BEAT_GUITARIST_TREY
; Juggler
	const EVENT_BEAT_JUGGLER_IRWIN
	const EVENT_BEAT_JUGGLER_FRITZ
	const EVENT_BEAT_JUGGLER_HORTON
	const EVENT_BEAT_JUGGLER_HARLE
	const EVENT_BEAT_JUGGLER_CARLOS
; Gentleman
...
; Scientist
	...
	const EVENT_BEAT_SCIENTIST_RUSS
	const EVENT_BEAT_SCIENTIST_NORTON
	const EVENT_BEAT_SCIENTIST_AVERY
; Blackbelt
	const EVENT_BEAT_BLACKBELT_HIDEKI
	const EVENT_BEAT_BLACKBELT_YOSHI
	const EVENT_BEAT_BLACKBELT_KOISHI
...
; Hiker
	...
	const EVENT_BEAT_HIKER_ANTOINE
	const EVENT_BEAT_HIKER_FREDERICK
; Bug Catcher
...
; Officer
	...
	const EVENT_BEAT_OFFICER_CLAUDE
; CooltrainerM
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_GEMMA
...
; Skier
	...
	const EVENT_BEAT_SKIER_CAROLINE
	const EVENT_BEAT_SKIER_CARLENE
	const EVENT_BEAT_SKIER_JESSICA
; SwimmerM
...
; Doll Maniac
	...
	const EVENT_BEAT_DOLL_MANIAC_OLIVER
	const EVENT_BEAT_DOLL_MANIAC_MASON
	const EVENT_BEAT_DOLL_MANIAC_MONROE
	const EVENT_BEAT_DOLL_MANIAC_SHAUN
	const EVENT_BEAT_DOLL_MANIAC_LOGAN
	const EVENT_BEAT_DOLL_MANIAC_LUCIUS
	const EVENT_BEAT_DOLL_MANIAC_HORACE
	const EVENT_BEAT_DOLL_MANIAC_LUKE
	const EVENT_BEAT_DOLL_MANIAC_MORGAN
	const EVENT_BEAT_DOLL_MANIAC_MATEO
	const EVENT_BEAT_DOLL_MANIAC_CASPER
	const EVENT_BEAT_DOLL_MANIAC_JACKIE
	const EVENT_BEAT_DOLL_MANIAC_ARCHIE
	const EVENT_BEAT_DOLL_MANIAC_RUPERT
...
; Johto itemballs
	...
	const EVENT_ICE_PATH_1F_ESCAPE_ROPE
...
; Kanto people
	...
	const EVENT_OFFICER_BLOCKS_UNDERGROUND_PATH
...
; Kanto itemballs
	...
	const EVENT_CERULEAN_CAVE_2F_TWISTEDSPOON
	const EVENT_CERULEAN_CAVE_2F_SUN_STONE
	const EVENT_CERULEAN_CAVE_2F_BIG_MUSHROOM
...
; New to Crystal Awakening
	const EVENT_RECEIVED_STONE
	const EVENT_GAVE_STONE
	const EVENT_GAVE_HONEYPOT
	const EVENT_GAVE_GEL_PEN
	const EVENT_GAVE_HAIRTIE
	const EVENT_GAVE_LUCKY_GEM
	const EVENT_GAVE_OLD_SANDWICH
	const EVENT_GAVE_GOLD_PEARL
	const EVENT_GAVE_COMPASS
	const EVENT_GAVE_HARDTACK
	const EVENT_GAVE_DARK_SHELL
	const EVENT_GAVE_CLIPBOARD
	const EVENT_GAVE_TABLOID
	const EVENT_HONEYPOT_CUTSCENE
	const EVENT_BLACKBELT_IN_SILPH_CO
	const EVENT_GRAMPS_OUTSIDE_MT_SILVER
	const EVENT_REDS_HOUSE_MASTER_BALL
	const EVENT_ANIMATED_MOOMOO
	const EVENT_TALKED_TO_EVO_GUY_ONCE
	const EVENT_SILPH_CO_RD_SCIENTIST_1
	const EVENT_SILPH_CO_RD_SCIENTIST_3
	const EVENT_BOULDER_IN_VICTORY_ROAD_1F
	const EVENT_BOULDER_IN_VICTORY_ROAD_3F
	const EVENT_BOULDER_IN_VICTORY_ROAD_2F
	...
	const EVENT_SWITCH_BOULDER_VICTORY_ROAD_1F
	const EVENT_VICTORY_ROAD_2F_BOULDER_1
	const EVENT_VICTORY_ROAD_2F_BOULDER_1_SWITCH
	const EVENT_WEST_SWITCH_IN_VICTORY_ROAD_2F
	const EVENT_VICTORY_ROAD_2F_BOULDER_2
	const EVENT_VICTORY_ROAD_2F_BOULDER_2_SWITCH
	const EVENT_EAST_SWITCH_IN_VICTORY_ROAD_2F	
	const EVENT_VICTORY_ROAD_3F_BOULDER
	const EVENT_VICTORY_ROAD_3F_BOULDER_SWITCH
	const EVENT_SWITCH_IN_VICTORY_ROAD_3F	
