...
Route28SteelWingHouse_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, CelebrityHouseBookshelf
	bg_event  3,  1, BGEVENT_READ, CelebrityHouseBookshelf

	def_object_events
	object_event  4,  3, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Celebrity, -1
	object_event  8,  5, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CelebritysFearow, -1
