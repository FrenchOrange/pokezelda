...
EcruteakItemfinderHouse_MapEvents:
	...
	def_warp_events
	warp_event  5,  7, ECRUTEAK_CITY, 11
	warp_event  6,  7, ECRUTEAK_CITY, 11
	...
	def_object_events
	object_event  4,  3, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, EcruteakItemfinderGuy, -1
	object_event  5,  3, SPRITE_POKEDEX, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakHistoryBook, -1
