...
PlayersHouse1FOvenScript:
	jumptext PlayersHouse1FOvenText

PlayersHouse1FCounterScript:
	jumptext PlayersHouse1FCounterText

PlayersHouse1FPantryScript:
	jumptext PlayersHouse1FPantryText
...
PlayersHouse1FOvenText:
	text "In the oven…"
	line "Mom's specialty!"

	para "CINNABAR VOLCANO"
	line "STEW!"
	done

PlayersHouse1FCounterText:
	text "The counter is"
	line "spotless. Mom"
	cont "likes it clean."
	done

PlayersHouse1FPantryText:
...
PlayersHouse1F_MapEvents:
	...
	def_coord_events
	coord_event 10,  4, SCENE_DEFAULT, MeetMomLeftScript
	coord_event 11,  4, SCENE_DEFAULT, MeetMomRightScript

	def_bg_events
	bg_event  1,  1, BGEVENT_READ, PlayersHouse1FOvenScript
	bg_event  2,  1, BGEVENT_READ, PlayersHouse1FCounterScript
	bg_event  3,  1, BGEVENT_READ, PlayersHouse1FPantryScript
	...
	object_event  6,  3, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, NeighborScript, EVENT_PLAYERS_HOUSE_1F_NEIGHBOR
