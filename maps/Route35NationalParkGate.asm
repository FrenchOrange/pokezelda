	...
	const ROUTE35NATIONALPARKGATE_GENTLEMAN
...
Route35NationalParkGateGentlemanScript:
	jumptextfaceplayer Route35NationalParkGateGentlemanText
...
Route35NationalParkGateGentlemanText:
	text "I'm the one who"
	line "organizes the Bug-"
	cont "Catching Contest!"

	para "We didn't have"
	line "many participants"
	cont "at first. But now,"
	para "we've built such a"
	line "great community!"

	para "I'm happy that"
	line "everyone seems to"
	cont "be having fun!"
	done
...
Route35NationalParkGate_MapEvents:
	...
	def_warp_events
	warp_event  5,  0, NATIONAL_PARK, 3
	warp_event  6,  0, NATIONAL_PARK, 4
	warp_event  5,  7, ROUTE_35, 3
	warp_event  6,  7, ROUTE_35, 3

	def_coord_events

	def_bg_events
	bg_event  7,  0, BGEVENT_READ, BugCatchingContestExplanationSign

	def_object_events
	object_event  4,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route35OfficerScriptContest, EVENT_ROUTE_35_NATIONAL_PARK_GATE_OFFICER_CONTEST_DAY
	object_event  8,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route35NationalParkGateYoungsterScript, EVENT_ROUTE_35_NATIONAL_PARK_GATE_YOUNGSTER
	object_event  2,  3, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route35NationalParkGateOfficerScript, EVENT_ROUTE_35_NATIONAL_PARK_GATE_OFFICER_NOT_CONTEST_DAY
	object_event  8,  3, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route35NationalParkGateGentlemanScript, -1
