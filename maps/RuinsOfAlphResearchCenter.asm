...
RuinsOfAlphResearchCenter_MapEvents:
	...
	def_bg_events
	bg_event  8,  5, BGEVENT_READ, RuinsOfAlphResearchCenterBookshelf
	bg_event  5,  4, BGEVENT_READ, RuinsOfAlphResearchCenterComputer
	bg_event  9,  1, BGEVENT_READ, RuinsOfAlphResearchCenterPrinter
	bg_event  7,  0, BGEVENT_READ, RuinsOfAlphResearchCenterPhoto
