...
SaffronGym_MapEvents:
	...
	def_warp_events
	warp_event 10, 18, SAFFRON_CITY, 2
	warp_event 11, 18, SAFFRON_CITY, 2
	warp_event 13, 15, SAFFRON_GYM, 18
	warp_event 21, 15, SAFFRON_GYM, 19
	warp_event 21, 11, SAFFRON_GYM, 20
	warp_event  3, 11, SAFFRON_GYM, 21
	warp_event  7,  3, SAFFRON_GYM, 22
	warp_event 13,  5, SAFFRON_GYM, 23
	warp_event  3, 15, SAFFRON_GYM, 24
	warp_event 21,  3, SAFFRON_GYM, 25
	warp_event 17, 17, SAFFRON_GYM, 26
	warp_event  7, 17, SAFFRON_GYM, 27
	warp_event  7,  9, SAFFRON_GYM, 28
	warp_event 11,  3, SAFFRON_GYM, 29
	warp_event 17,  9, SAFFRON_GYM, 30
	warp_event 17,  5, SAFFRON_GYM, 31
	warp_event  3,  5, SAFFRON_GYM, 32
	warp_event 21, 17, SAFFRON_GYM, 3
	warp_event 21,  9, SAFFRON_GYM, 4
	warp_event  3,  9, SAFFRON_GYM, 5
	warp_event  7,  5, SAFFRON_GYM, 6
	warp_event 13,  3, SAFFRON_GYM, 7
	warp_event  3, 17, SAFFRON_GYM, 8
	warp_event 21,  5, SAFFRON_GYM, 9
	warp_event 17, 15, SAFFRON_GYM, 10
	warp_event  7, 15, SAFFRON_GYM, 11
	warp_event  7, 11, SAFFRON_GYM, 12
	warp_event 11,  5, SAFFRON_GYM, 13
	warp_event 17, 11, SAFFRON_GYM, 14
	warp_event 17,  3, SAFFRON_GYM, 15
	warp_event  3,  3, SAFFRON_GYM, 16
	warp_event 13,  9, SAFFRON_GYM, 17
	...
	def_object_events
	object_event 11,  8, SPRITE_SABRINA, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaffronGymSabrinaScript, -1
	object_event 19, 16, SPRITE_GRANNY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerMediumRebecca, -1
	object_event  5, 16, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPsychicFranklin, -1
	object_event  5,  4, SPRITE_GRANNY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 2, TrainerMediumDoris, -1
	object_event 19,  4, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerPsychicJared, -1
	object_event 11, 14, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SaffronGymGuideScript, -1
