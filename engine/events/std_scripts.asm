...
BugContestResultsWarpScript:
	...
	warp ROUTE_36_NATIONAL_PARK_GATE, 3, 5
...
InitializeEventsScript:
	...
	setevent EVENT_ANIMATED_MOOMOO
	...
	setevent EVENT_BOULDER_IN_VICTORY_ROAD_2F
	setevent EVENT_BOULDER_IN_SEAFOAM_B1F_1
	setevent EVENT_BOULDER_IN_SEAFOAM_B1F_2
	...
	setevent EVENT_BOULDER_IN_SEAFOAM_B4F_1
	setevent EVENT_BOULDER_IN_SEAFOAM_B4F_2
	setevent EVENT_SWITCH_BOULDER_VICTORY_ROAD_1F
	setevent EVENT_VICTORY_ROAD_2F_BOULDER_1_SWITCH
	setevent EVENT_VICTORY_ROAD_2F_BOULDER_2_SWITCH
	setevent EVENT_VICTORY_ROAD_3F_BOULDER_SWITCH
	...
	setevent EVENT_ONIX_DOLL_RECEPTIONIST
	...
	setevent EVENT_OAKS_LAB_BLUE
	setevent EVENT_SEAFOAM_GYM_GYM_GUIDE
	setevent EVENT_MT_MOON_SQUARE_CLEFAIRY
	setevent EVENT_SAFFRON_TRAIN_STATION_POPULATION
	setevent EVENT_INDIGO_PLATEAU_POKECENTER_RIVAL
	setevent EVENT_HONEYPOT_CUTSCENE
	setevent EVENT_BLACKBELT_IN_SILPH_CO
	setevent EVENT_GRAMPS_OUTSIDE_MT_SILVER
	setevent EVENT_REDS_HOUSE_MASTER_BALL
