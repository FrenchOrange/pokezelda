...
AzaleaGym_MapEvents:
	...
	def_warp_events
	warp_event  6, 17, AZALEA_TOWN, 5
	warp_event  7, 17, AZALEA_TOWN, 5

	def_coord_events

	def_bg_events
	bg_event  5, 15, BGEVENT_READ, AzaleaGymStatue
	...
	object_event  6, 12, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 1, TrainerTwinsAmyandmay1, -1
	object_event  7, 12, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_TRAINER, 1, TrainerTwinsAmyandmay2, -1
	object_event  9, 15, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, AzaleaGymGuideScript, -1
