...
Route6_MapEvents:
	...
	def_warp_events
	warp_event 21, 13, ROUTE_6_UNDERGROUND_PATH_ENTRANCE, 1
	warp_event 14,  7, ROUTE_6_SAFFRON_GATE, 3
	warp_event 14,  3, ROUTE_6_SAFFRON_GATE, 1
	warp_event 15,  3, ROUTE_6_SAFFRON_GATE, 2

	def_coord_events

	def_bg_events
	bg_event 23, 15, BGEVENT_READ, Route6UndergroundPathSign

	def_object_events
	object_event 21, 14, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 2, Route6OfficerScript, EVENT_OFFICER_BLOCKS_UNDERGROUND_PATH
	object_event 13, 20, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, TrainerPokefanmRex, -1
