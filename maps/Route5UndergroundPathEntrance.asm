...
Route5UndergroundPathEntrance_MapEvents:
	...
	def_warp_events
	warp_event  5,  7, ROUTE_5, 1
	warp_event  6,  7, ROUTE_5, 1
	warp_event  6,  3, UNDERGROUND_PATH, 1
	...
	def_object_events
	object_event  4,  2, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route5UndergroundPathEntranceTeacherScript, -1
