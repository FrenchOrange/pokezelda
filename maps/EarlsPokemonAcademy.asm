...
EarlsPokemonAcademy_MapEvents:
	...
	def_bg_events
	bg_event  2,  1, BGEVENT_READ, AcademyBookshelf
	bg_event  3,  1, BGEVENT_READ, AcademyBookshelf
	bg_event  5,  0, BGEVENT_READ, AcademyBlackboard
	bg_event  6,  0, BGEVENT_READ, AcademyBlackboard

	def_object_events
	object_event  6,  2, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, AcademyEarl, EVENT_EARLS_ACADEMY_EARL
	object_event  4,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, EarlsPokemonAcademyYoungster1Script, -1
	object_event  5, 11, SPRITE_GAMEBOY_KID, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EarlsPokemonAcademyGameboyKid1Script, -1
