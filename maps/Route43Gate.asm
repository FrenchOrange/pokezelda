...
CooltrainerMText:
	text "A fisherman by the"
	line "lake is after the"
	cont "world's largest"
	cont "MAGIKARP."
...
Route43Gate_MapEvents:
	...
	def_warp_events
	warp_event  6,  0, ROUTE_43, 4
	warp_event  7,  0, ROUTE_43, 5
	warp_event  6,  7, ROUTE_43, 3
	warp_event  7,  7, ROUTE_43, 3
	...
	def_object_events
	object_event  2,  4, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, OfficerScript_GuardWithSludgeBomb, EVENT_LAKE_OF_RAGE_CIVILIANS
	object_event  4,  4, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RocketScript_MakingABundle, EVENT_ROUTE_43_GATE_ROCKETS
	object_event  9,  4, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RocketScript_MakingABundle, EVENT_ROUTE_43_GATE_ROCKETS
	object_event  8,  4, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CooltrainerMScript, EVENT_LAKE_OF_RAGE_CIVILIANS
