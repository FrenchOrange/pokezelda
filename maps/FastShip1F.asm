...
WorriedGrandpaSceneRight:
	moveobject FASTSHIP1F_GENTLEMAN, 22, 6
...
FastShip1F_MapEvents:
	...
	def_warp_events
	warp_event 27,  1, FAST_SHIP_1F, -1
	warp_event 29,  8, FAST_SHIP_CABINS_NNW_NNE_NE, 1
	warp_event 25,  8, FAST_SHIP_CABINS_NNW_NNE_NE, 2
	warp_event 21,  8, FAST_SHIP_CABINS_NNW_NNE_NE, 3
	warp_event 17,  8, FAST_SHIP_CABINS_SW_SSW_NW, 1
	warp_event 17, 15, FAST_SHIP_CABINS_SW_SSW_NW, 2
	warp_event 21, 15, FAST_SHIP_CABINS_SW_SSW_NW, 4
	warp_event 25, 15, FAST_SHIP_CABINS_SE_SSE_CAPTAINS_CABIN, 1
	warp_event 29, 15, FAST_SHIP_CABINS_SE_SSE_CAPTAINS_CABIN, 3
	warp_event  5, 13, FAST_SHIP_CABINS_SE_SSE_CAPTAINS_CABIN, 5
	warp_event  8, 12, FAST_SHIP_B1F, 1
	warp_event 32, 14, FAST_SHIP_B1F, 2

	def_coord_events
	coord_event 26,  6, SCENE_FASTSHIP1F_MEET_GRANDPA, WorriedGrandpaSceneLeft
	coord_event 27,  6, SCENE_FASTSHIP1F_MEET_GRANDPA, WorriedGrandpaSceneRight

	def_bg_events

	def_object_events
	object_event 27,  2, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FastShip1FSailor1Script, -1
	object_event 16,  7, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FastShip1FSailor2Script, -1
	object_event 24, 17, SPRITE_SAILOR, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FastShip1FSailor3Script, -1
	object_event 21,  6, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_FAST_SHIP_1F_GENTLEMAN
