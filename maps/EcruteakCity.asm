...
EcruteakCity_MapEvents:
	...
	warp_event 22,  2, WISE_TRIOS_ROOM, 1
	warp_event 22,  3, WISE_TRIOS_ROOM, 2
	...
	object_event  3,  9, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, EcruteakCityLass2Script, -1
