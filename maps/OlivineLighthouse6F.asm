...
.BroughtSecretpotion:
	...
	showemote EMOTE_BOLT, OLIVINELIGHTHOUSE6F_MONSTER, 25
	cry AMPHAROS
...
OlivineLighthouseAmphy:
	...
	setval AMPHAROS
	special PlaySlowCry
	showemote EMOTE_SAD, OLIVINELIGHTHOUSE6F_MONSTER, 25
	promptbutton
...
OlivineLighthouse6F_MapEvents:
	...
	def_object_events
	object_event  8,  8, SPRITE_JASMINE, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouseJasmine, EVENT_OLIVINE_LIGHTHOUSE_JASMINE
	object_event  9,  8, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouseAmphy, -1
